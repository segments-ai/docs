...
5. Press the "step forward" button (![](<../../.gitbook/assets/image (1) (1) (1) (1) (1).png>)) to propagate the cuboid forward one frame, or press the "forward"  button (![](<../../.gitbook/assets/image (10).png>)) to propagate the cuboid forward until the end of the sequence.
