...
In some cases it can be useful to play through a sequence to help visualize how the scene and the annotations change. This playback can be triggered using the _Play_ button in the timeline.
